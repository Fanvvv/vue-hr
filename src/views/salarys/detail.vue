<!--
 * @Author: fan
 * @Date: 2021-07-19 19:38:20
 * @LastEditors: fan
 * @LastEditTime: 2021-07-19 19:40:11
 * @Description: 详情页
-->
<template>
    ...
    <div class="contLeft">
      <div class="topTit">
        ...
        <div class="info">
          ...
          <div class="time">入职时间: {{ user.timeOfEntry | formatDate }} 最新工资： {{ formLabelAlign.currentPostWage + formLabelAlign.currentBasicSalary }}
            <ul>
