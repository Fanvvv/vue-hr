      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">早安！ {{ name }} ，今天又是美好的一天！</p>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    >
                    <div>
                      <p><span class="col">白鹭</span> 发布了 第1期互动讨论获奖名单公布</p>
                      <p>2021-07-02 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    ...
                    >
                    <div>
                      <p><span class="col">白鹭</span> 发布了 第2期互动讨论获奖名单公布</p>
                      <p>2021-07-09 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    ...
                    >
                    <div>
                      <p><span class="col">白鹭</span> 发布了 第3期互动讨论获奖名单公布</p>
                      <p>2021-07-16 15:21:38</p>
                    </div>
                  </div>
                </li>
              </ul>
